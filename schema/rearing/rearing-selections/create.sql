...
CREATE TABLE rearing_selections (
    ...
    weight_at_selection NUMERIC(6,2),
...
-- 2026-04-14: agrega local_id para idempotencia offline
ALTER TABLE rearing_selections ADD COLUMN IF NOT EXISTS local_id VARCHAR(100) UNIQUE;
